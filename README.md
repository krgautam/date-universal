# date-universal [![Coverage Status](https://coveralls.io/repos/github/krgautam/date-universal/badge.svg?branch=master)](https://coveralls.io/github/krgautam/date-universal?branch=master)
